...
# Funçõo parar gerar nomes aleatorios com base no banco de nomes 
def gerarContantos():
    contatos = []
...
#  Função gerarArquivo : gera o arquivo "contantos.txt", como nomes e números telefonicos aleátorios 
def gerarArquivo():
    with open('contatos.txt', 'w') as arquivo:
        for contato in gerarContantos():
